...
| EURES CH/NL | Admin-only pending approved public data access | Retain separate policy evidence. Specific vacancy terms restrict extraction to recognized partners; general EU reuse wording does not establish permission. UWV/SECO assumptions do not grant EURES access. |
