...
const USER_AGENT = 'IkBenEenAppel/0.1 personal job-search companion';
...
export interface JobSourceAdapter {
   ...
   * IamExpat is read from public pages rather than an API. Both are retained for the owner and
   * neither is offered as a public feature.
   *
