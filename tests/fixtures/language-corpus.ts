...
export const languageCorpus: CorpusCase[] = [
  ...
  },
  {
    ...
    expected: 'review',
    tests: 'a language word used as a nationality or market. Conservative on purpose: review costs a look, pass costs a wasted application',
  },
  {
    ...
    expected: 'review',
    tests: 'known limitation - an explicit denial still reads as a mention. Errs safe, so recorded rather than fixed',
  },
  {
    ...
    expected: 'review',
    tests: 'known limitation - a language offered as a perk reads as a mention. Errs safe',
  },
  {
    id: 'review-bilingual',
    ...
    expected: 'review',
    tests: 'known limitation - "bilingual in X and Y" is a requirement but lands in review rather than blocked. Under-blocks into the safe bucket',
  },
